...
const BLOCK = {
  ...
  sessions: {
    ...
    push: {
      ...
      movements: [
        { name: "DB Bench Press", current: "35 lb", steps: DUMBBELL_STEPS, reps: 10, target: "NO COACH TARGET AUTHORED YET \u2014 restored to the default chest slot Sep 8 2026 (CHANGES.md Phase 3/4). Logged 45 lb on 4/6, then twice as prose in a zero-set note because it wasn't selectable: 30s x10 x3 @ RPE 5-6 (8/27) and 35s x10 x2 @ RPE 7 (9/5). The 35 fallback comes from that last note, not from a prescription." },

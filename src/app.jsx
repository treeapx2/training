...
const SEED_SESSIONS = [
  {
    ...
    label: "Push",
    date: "Feb 28, 2026",
    note: "Pre-Claude reference session. First two press sets had ~3 reps in reserve.",
    movements: [
      {
        name: "Floor Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Mar 1, 2026",
    note: "First session with Claude. True baseline established. Home weight ceiling identified.",
    movements: [
      {
        name: "Floor Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Mar 2, 2026",
    note: "Taper before hockey. Glute activation improving.",
    movements: [
      {
        name: "Floor Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Mar 6, 2026",
    note: "Press capacity confirmed well beyond 35 lb. Home weight ceiling identified.",
    movements: [
      {
        name: "Floor Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Mar 7, 2026",
    note: "First gym session. 45 lb flat and 45 lb row baselines established.",
    movements: [
      {
        name: "Flat DB Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Mar 10, 2026",
    note: "Overall fatigue from travel. Floor push cue introduced for RDL.",
    movements: [
      {
        name: "Floor Press",
        sets: [
        ...
        sets: [
          {
            ...
            reps: "10",
            rpe: "",
            note: "floor push cue introduced",
          },
          {
            set: 2,
            weight: "20",
  ...
  },
  {
    ...
    label: "Push",
    date: "Mar 14, 2026",
    note: "Tempo making 35 lb genuinely challenging. Dead bug and side plank form improved.",
    movements: [
      {
        name: "Floor Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Mar 16, 2026",
    note: "Left knee tight, not painful. No lower body due to knee and hockey next day.",
    movements: [
      {
        name: "Floor Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Mar 21, 2026",
    note: "Tempo at 45 lb working well. Left side deficit identified across lunges and side plank.",
    movements: [
      {
        name: "Flat DB Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "Mar 22, 2026",
    note: "50 lb row baseline established. First leg press session. Left knee snap on single leg — flagged.",
    movements: [
      {
        name: "DB Row",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "15",
            rpe: "8",
            note: "bilateral knee pressure post-session",
          },
        ],
      },
    ],
  },
  {
    ...
    label: "Legs",
    date: "Mar 23, 2026",
    note: "Left knee snap on single leg press at 60 lb — do not progress single leg. Right knee taking more load than left.",
    movements: [
      {
        name: "Leg Press",
        sets: [
          ...
          },
          {
            ...
            reps: "12",
            rpe: "7",
            note: "right knee taking more load",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Legs",
    date: "Mar 28, 2026",
    note: "Left knee pressure on RDL hinge only. Leg curl ceiling found at 60 lb, rebuild from 45.",
    movements: [
      {
        name: "Leg Press",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "12",
            rpe: "8",
            note: "full-range hamstring tightness — do not use 60 as working weight",
          },
        ],
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "",
            note: "left knee pressure on hinge",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Push",
    date: "Mar 29, 2026",
    note: "Medium energy. Wrist fully cleared. Incline held at 40 lb next session.",
    movements: [
      {
        name: "Flat DB Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "Mar 30, 2026",
    note: "Hamstrings still tight from 3/28. Elbow tightness appeared at end — monitor.",
    movements: [
      {
        name: "DB Row",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Apr 3, 2026",
    note: "First machine session. Thumb sore on shoulder press, dropped from 75 to 60 lb.",
    movements: [
      {
        name: "Chest Press",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "Apr 4, 2026",
    note: "Knee felt good throughout. Hamstring tightness present at 60 lb leg curl.",
    movements: [
      {
        name: "Leg Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "Apr 5, 2026",
    note: "Elbow good throughout. Wrist pressure on cable curl straight bar — try EZ bar.",
    movements: [
      {
        name: "DB Row",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "8",
            note: "wrist pressure from straight bar",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "11",
            rpe: "",
            note: "hit failure at rep 9 on set 3",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Push",
    date: "Apr 6, 2026",
    note: "Thumb held up. Rope pushdown taken at gym, skipped. 40 min before travel.",
    movements: [
      {
        name: "DB Bench Press",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "Apr 9, 2026",
    note: "Knee felt good throughout. Hamstring tightness consistent at 60 lb.",
    movements: [
      {
        name: "Leg Press",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "11",
            rpe: "",
            note: "movement still inconsistent",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Pull",
    date: "Apr 10, 2026",
    note: "Fatigued — skipped home portion. Elbow tightness reappeared at end under load.",
    movements: [
      {
        name: "Lat Pulldown",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "6",
            rpe: "9",
            note: "elbow tightness, tempo breaking down",
          },
        ],
      },
    ],
  },
  {
    ...
    label: "Push",
    date: "Apr 11, 2026",
    note: "Thumb sore but not worsening. Rope pushdown progressed to 37.5 lb.",
    movements: [
      {
        name: "Chest Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Apr 14, 2026",
    note: "2+2 structure formalized this session. Home portion skipped due to time.",
    movements: [
      {
        name: "Chest Press",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "9",
            note: "dropped back due to fatigue",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Legs",
    date: "Apr 17, 2026",
    note: "New flags — groin soreness (L>R) and left knee below patella (new sensation).",
    movements: [
      {
        name: "Leg Press",
        sets: [
        ...
        sets: [
          {
            ...
            reps: "12",
            rpe: "7",
            note: "groin tightness mid-session",
          },
          {
            set: 2,
            weight: "35",
            reps: "12",
            rpe: "7",
            note: "left knee below patella flagged",
          },
          {
            set: 3,
            weight: "35",
            reps: "12",
            rpe: "",
            note: "left groin tightness painful but finished strongly",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Pull",
    date: "Apr 19, 2026",
    note: "Cable curl rebaselined at 37.5 lb on this machine. Hammer curl hitting failure.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "Apr 24, 2026",
    note: "Leg press clean. Groin tightness in goblet squats settled by end. Knee tightness in RDL — likely fatigue.",
    movements: [
      {
        name: "Leg Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Apr 25, 2026",
    note: "3 WU + 2 working formalized for Push. Chest press ceiling at 3 sets. No rope available.",
    movements: [
      {
        name: "Chest Press",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "9",
            note: "no 80 available, next jump 90",
          },
        ],
      },
      {
        ...
        sets: [
          {
            ...
            reps: "10",
            rpe: "6",
            note: "back sensation — elbow flare",
          },
          {
            set: 2,
            weight: "20",
  ...
  },
  {
    ...
    label: "Pull",
    date: "Apr 26, 2026",
    note: "New ramp structure: 1 WU + 2 build + 2 working. DB Row 50 lb at RPE 9 — tempo likely broke down.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "May 1, 2026",
    note: "Conservative start — time crunch. Knee and groin clean. Skipped RDL and glute bridge.",
    movements: [
      {
        name: "Leg Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "May 2, 2026",
    note: "Rope unavailable. Chest press ceiling confirmed at 105 — needs clean 3×10 before progression. No 80 lb on shoulder press — next jump is 90.",
    movements: [
      {
        name: "Chest Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "May 3, 2026",
    note: "No 45s available for DB Row. Zottmans dropped — biceps cooked after cables and hammers.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "May 8, 2026",
    note: "Knee and groin clean. R hamstring pain at 75 lb final set — drop back to 60 lb ceiling. Goblet squat 4x solid.",
    movements: [
      {
        name: "Leg Press",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "8",
            note: "R hamstring pain final reps — drop back to 60 ceiling",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Push",
    date: "May 9, 2026",
    note: "Shoulder press 90x6x2 RPE 9 — ceiling test, not working weight yet. Back discomfort on shoulder press — brace cue needed. Rope pushdown 42.5 also at ceiling, back to 37.5 working.",
    movements: [
      {
        name: "Chest Press",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "6",
            rpe: "9",
            note: "back discomfort — brace cue",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Pull",
    date: "May 10, 2026",
    note: "Seated row 120 confirmed. Lat pulldown 120 not ready — back to 105 working. DB row 45 clean baseline. Time-crunched, reverse fly/hammers/zottmans dropped.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "May 13, 2026",
    note: "Sore from hockey but clean session. Low back monitored — no issues. Goblet squat best yet — RPE 6/6, no flags.",
    movements: [
      {
        name: "Leg Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "May 15, 2026",
    note: "Tested 120 on chest press and pec fly — ceiling, not working weight. Shoulder press done on DBs at 70 lb — harder than machine, track separately. OHE dropped — back discomfort. Rope pushdown at 42.5 looking close.",
    movements: [
      {
        name: "Chest Press",
        sets: [
        ...
        sets: [
          {
            ...
            reps: "10",
            rpe: "7",
            note: "DBs today — harder than machine",
          },
          {
            set: 2,
            weight: "70",
  ...
  },
  {
    ...
    label: "Pull",
    date: "May 16, 2026",
    note: "Hammers and Zottmans moved earlier — better quality. Zottman jumped to 20 lb, 8 reps baseline. Lat pulldown close to 120.",
    movements: [
      {
        name: "Seated Row",
        sets: [
        ...
        sets: [
          {
            ...
            reps: "8",
            rpe: "8",
            note: "jumped from 15 — form ok, reps suffered",
          },
          {
            set: 2,
            weight: "20",
  ...
  },
  {
    ...
    label: "Legs",
    date: "May 19, 2026",
    note: "Leg press tested 170 — strong. Leg extension to 150. Leg curl to 75 — monitor R hamstring. Goblet squat clean at 40.",
    movements: [
      {
        name: "Leg Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "May 21, 2026",
    note: "Pec fly 120 confirmed as new working weight. Chest press and shoulder press still at ceiling. Lateral raise jumped to 15 — reps dropped on S3. Rope pushdown 5 lb increments.",
    movements: [
      {
        name: "Chest Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "May 22, 2026",
    note: "Seated row 120 consistent. Lat pulldown 120 RPE 9 on W2 — one more session. DB row ready to test 50. Zottman back to 15 lb.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "May 23, 2026",
    note: "Seated row 120 consistent. Lat pulldown 120 RPE 9 on W2 — one more session. DB row ready for 50. Zottman back to 15 lb.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "May 24, 2026",
    note: "Chest press 120 confirmed working weight. Rope pushdown 42.5 locked in. Skull crushers new — elbow sensation on final reps, monitor. Lateral raise still dropping reps at 15 straight.",
    movements: [
      {
        name: "Chest Press",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "6",
            rpe: "9",
            note: "reps dropping — back to 12/12/15/15",
          },
        ],
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "8",
            note: "elbow sensation on final reps — monitor",
          },
        ],
      },
    ],
  },
  {
    ...
    label: "Pull",
    date: "May 25, 2026",
    note: "DB row 50 and cable curl 42.5 both confirmed. Rows/pulldown harder after DB work — rotating order weekly going forward. Reverse fly ready to test 20.",
    movements: [
      {
        name: "Seated Row",
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "9",
            note: "fatigued from DB work first",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Legs",
    date: "May 27, 2026",
    note: "Goblet squat jumped to 45 — clean. Leg curl 75 RPE improving. Calf raise ready for 40. Pre-vacation session.",
    movements: [
      {
        name: "Leg Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Jun 2, 2026",
    note: "First session back after vacation week. Completed as planned.",
    movements: [
      {
        name: "Chest Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "Jun 6, 2026",
    note: "Lat pulldown ready to test 135. Zottman 20 lb confirmed. Hammer curl jumped to 25 — ceiling not working weight, back to 20. DB row single working set at 45.",
    movements: [
      {
        name: "Seated Row",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "6",
            rpe: "9",
            note: "ceiling not working weight",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Push",
    date: "Jun 7, 2026",
    note: "Rope pushdown ready for 47.5. Chest press 120 still ceiling. Lateral raise reps dropping — form or fatigue. Skull crusher skipped. Shoulder press 3 sets only.",
    movements: [
      {
        name: "Chest Press",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "Jun 10, 2026",
    note: "Leg curl up to 90 lb — R hamstring RPE 7/8, no pain. Leg extension reps dropped at 150 — back to 135 working. Goblet squat 45 hold. Order: curls → goblet → calves → press → extension.",
    movements: [
      {
        name: "Leg Curl",
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "8",
            note: "new ceiling — R hamstring clean",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Pull",
    date: "Jun 11, 2026",
    note: "Lat pulldown ramp skipped — RPE 9 at 120, back to 105 working. DB row ready for 50. Cable curl 47.5 ceiling test. Hammer curl reps dropping late in session.",
    movements: [
      {
        name: "Seated Row",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "9",
            note: "skipped ramp — back to 105 working",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "8",
            rpe: "8",
            note: "reps down — late in session",
          },
        ],
      },
    ],
  },
  {
    ...
    label: "Push",
    date: "Jun 13, 2026",
    note: "Pec fly reps dropped at 120 — back to 105 working. Skull crusher dropped to 12 lb — elbow adapting. Shoulder press 90x8x2 — holding. Lateral raise 12x10x4 clean.",
    movements: [
      {
        name: "Chest Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "Jun 14, 2026",
    note: "Seated row and lat pulldown clean at 120. Lat pulldown ready for 135. Cable curl tested 47.5.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Jun 20, 2026",
    note: "Lateral raise 12x10x4 RPE 6/6/7/7 — ready to test 15 on S3/S4. Chest press and pec fly holding at 120.",
    movements: [
      {
        name: "Chest Press",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "10",
            rpe: "7",
            note: "ready to test 15 on S3/S4",
          },
        ],
      },
    ],
  },
  {
    ...
    label: "Pull",
    date: "Jun 21, 2026",
    note: "Seated row and lat pulldown both RPE 7/7 at 120 — both ready for 135. Cable curl reps dropped at 47.5 — back to 42.5 working. Zottman reps low at 20.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "Jun 24, 2026",
    note: "Leg extension back to 150 cleanly — regression resolved. Goblet squat ready for 50. Calf raise ready for 40. Leg curl 90 held.",
    movements: [
      {
        name: "Leg Press",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Jun 27, 2026",
    note: "Chest press plateau confirmed — 120 holding but reps dropping (8/6/6, RPE 8-9). Skull crusher clean at 15 (10/10). Rope pushdown pushed 42.5 again (6/6). Lateral raise 15 lb building. Shoulder press topped at 75x6.",
    movements: [
      {
        name: "Chest Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "Jun 30, 2026",
    note: "Seated row first working session at 135 (4/5/5, RPE 8). Hammer curl 4 clean sets at 20 - ready for 25. DB row holding 50 (8/6). Cable curl 42.5 (8/8). Lat pulldown + reverse fly skipped.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Push",
    date: "Jul 1, 2026",
    note: "Chest press BROKE PLATEAU — clean 10/10 at 120 (RPE 7-8), first clean 10s across the plateau stretch, ready to test 135. Pec fly clean 10/10 at 120. Rope pushdown recovered to 42.5. Shoulder press skipped.",
    movements: [
      {
        name: "Chest Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "Jul 4, 2026",
    note: "Lat pulldown 135 TEST PASSED — clean 8/8 @ RPE 8, now working weight. Seated row 135 clean 8/8 (up from 4/5/5 on 6/30). Cable curl clean 10/10 @ 42.5, ready for 47.5. Hammer curl held 20 (8/8/8, back-half fatigue), 25 deferred. DB row light (40x2, back-half). Zottman still 6 reps. Reverse fly skipped.",
    movements: [
      {
        name: "Seated Row",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "8",
            rpe: "8",
            note: "back-half fatigue, 25 deferred",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    label: "Push",
    date: "Jul 5, 2026",
    note: "Skull crusher tested 20lb - 10x2 RPE 7/8 confirmed. Shoulder press 90x10x2 RPE 7/8 - first clean 10s. Lateral raise 15x10x2. Chest press reps dropped at 120.",
    movements: [
      {
        name: "Shoulder Press",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "Jul 8, 2026",
    note: "Leg curl 90x10x2 - first clean 10s at 90. Leg extension reps dropped at 150. Goblet conservative after gap. Calf raise held - test 40 next.",
    movements: [
      {
        name: "Leg Press",
        sets: [
  ...
  },
  {
    ...
    label: "Pull",
    date: "Jul 13, 2026",
    note: "Lat pulldown 135x10x2 confirmed. Seated row 135 building (6/6). DB row reps dropped at 45.",
    movements: [
      {
        name: "Seated Row",
        sets: [
  ...
  },
  {
    ...
    label: "Legs",
    date: "Jul 22, 2026",
    note: "Leg curl reps dropped to 6 at 90 - monitor lower back compensation. Leg extension still 8 reps at 150. Goblet squat very consistent at 45 - test 50 next. No calf raise.",
    movements: [
      {
        name: "Leg Press",
        sets: [
      ...
      },
      {
        ...
        sets: [
          ...
          },
          {
            ...
            reps: "6",
            rpe: "8",
            note: "reps dropped - monitor lower back",
          },
          {
            set: 5,
            weight: "90",
  ...
  },
  {
    ...
    label: "Pull",
    date: "Jul 25, 2026",
    note: "Upper-body re-entry after layoff — deliberately light. DB Row LED the session: 45x10 @ RPE 7 clean, best DB row log to date (fresh placement worked). Seated row + lat pulldown held at 120x10x2 @ RPE 7 (chosen deload, not regression). Cable curl 42.5x10x4 @ RPE 6-7 — second clean session, 47.5 next. Reverse fly 15x10x3 all @ RPE 6 — ready for 20. Hammer curl 20 read heavy cold (8 @ RPE 8), dropped to 15 and finished clean.",
    movements: [
      {
        name: "DB Row",
        sets: [
...
function loadData() {
  try {
    ...
    if (r) {
      ...
      const savedIds = new Set(saved.history.map((h) => h.id));
      const savedKeys = new Set(
        saved.history.map((h) => h.type + "|" + h.date),
      );
      const newSeeds = SEED_SESSIONS.filter(
        (s) => !savedIds.has(s.id) && !savedKeys.has(s.type + "|" + s.date),
      );
      if (newSeeds.length > 0) {
        const merged = [...saved.history, ...newSeeds].sort(
  ...
  const sorted = [...SEED_SESSIONS].sort(
    (a, b) => parseSessionDate(b.date) - parseSessionDate(a.date),
  );
  saveData(sorted);
  return sorted;
